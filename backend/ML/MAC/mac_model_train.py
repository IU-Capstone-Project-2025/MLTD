...
from mac_parser import parse_file
from sklearn.ensemble import IsolationForest
import matplotlib.pyplot as plt
import pickle

df = parse_file("Mac.log", for_train=True)
X = df["message"].tolist()
...
# embeddings = np.load("log_embeddings.npy") # already completed embeddings
...
with open('mac_model.pkl', 'wb') as f:
